<template>
  <div class="l" :style="{ height: height, width: width }">
    <div
      class="item_one"
      v-if="type == '吃'"
      style="border: 0.08rem solid rgba(231,92,94,1);"
    >
    ...
    <div
      class="item_one"
      v-if="type == '住'"
      style="border: 0.08rem solid #2ED9FD"
    >
    ...
    <div
      class="item_one"
      v-if="type == '行'"
      style="border: 0.08rem solid rgba(101,194,143,1);color: "
    >
    ...
    <div
      class="item_one"
      v-if="type == '游'"
      style="border: 0.08rem solid #2E9DDC;"
    >
    ...
    <div
      class="item_one"
      v-if="type == '购'"
      style="border: 0.08rem solid #1DBDB9;"
    >
    ...
    <div
      class="item_one"
      v-if="type == '娱'"
      style="border: 0.08rem solid #F16856;"
    >
    ...
    <div class="item_four">
      <div class="c1" :style="{ width: bindData1[0] + '%' }">
        现金:{{ bindData1[0] }}%
      </div>
      <div class="c2" :style="{ width: bindData1[1] + '%' }">
        微信{{ bindData1[1] }}%
      </div>
      <div class="c3" :style="{ width: bindData1[2] + '%' }">
        支付宝{{ bindData1[2] }}%
      </div>
      <div class="c4" :style="{ width: bindData1[3] + '%' }">
        刷卡{{ bindData1[3] }}%
      </div>
      <div class="c5" :style="{ width: bindData1[3] + '%' }">
        网银{{ bindData1[4] }}%
      </div>
    </div>
  </div>
