      ...
      http.get(json).then((mapJson) => {
          ...
          series.push(
            ...
            },
            {
              ...
              symbolSize: function(val) {
                ...
                return that.clientWidth > 1800 ? 7 : 5;
              },
              ...
              data: item[1].map(function(dataItem) {
                return {
                  ...
                  value: (
                    geoCoordMap[dataItem[0].name] || [120.766173, 37.815983]
        ...
        var option = {
          ...
          visualMap: {
            ...
            orient: "left",
            color: ["rgba(119,255,88,1)", "rgba(236,153,31,1)", "aqua"],
            textStyle: {
              color: "#fff",
            },
          },
