<template>
  <div :style="{ height: height, width: width }" id="mapBoxJQ"></div>
</template>
<script>
import jq from "../../assets/img/icon/jiaquan.png";
 ...
 */
    ...
    drawPoint(device) {
      ...
      var that = this;
      that.map = new AMap.Map("mapBoxJQ", {
        resizeEnable: true,
      ...
      function _onClick(e) {
        ...
        var content = `
          <div class="jiaquanBox tipsBox"><ul><li>当前甲醛含量:***</li>
        </ul>
          </div>
        `;
        // 创建 infoWindow 实例
