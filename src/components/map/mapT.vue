<template>
  <div :style="{ height: height, width: width }" id="mapBoxT"></div>
</template>
<script>
import t from "../../assets/img/icon/t.png";
 ...
 */
    ...
    drawPoint(device) {
      ...
      function _onClick(e) {
        ...
        // 定义弹出框
        var content = `
          <div class="tBox tipsBox"><ul><li>当前温度:25℃</li>
          <li>当前湿度:30%~80%</li>
        </ul>
          </div>
        `;
