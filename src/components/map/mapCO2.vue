<template>
  <div :style="{ height: height, width: width }" id="mapBoxC"></div>
</template>
<script>
import c from "../../assets/img/icon/co2.png";
 ...
 */
    ...
    drawPoint(device) {
      ...
      function _onClick(e) {
        ...
        var content = `
          <div class="coBox tipsBox"><ul><li>当前二氧化碳:***</li>
        </ul>
          </div>
        `;
        // 创建 infoWindow 实例
